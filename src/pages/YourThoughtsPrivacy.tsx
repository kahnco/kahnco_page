...
export default function YourThoughtsPrivacy() {
  return (
        ...
        >
          ...
          <Section title="2. 처리하는 개인정보 항목">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>기기 정보 (기기 모델명, 운영체제 버전)</li>
              <li>앱 사용 기록 (화면 조회, 검색 기록)</li>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>검색어 기록 (최근 검색어 최대 10개, 기기 내 저장)</li>
            </ul>

            <p className="mt-4 text-neutral-400">
              ※ 본 앱은 회원가입을 요구하지 않으며, 별도의 로그인 없이 모든
              기능을 이용할 수 있습니다.
            </p>
          </Section>
          ...
          <Section title="3. 개인정보의 처리 및 보유 기간">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                <span className="text-white">기기 내 저장 데이터 (검색 기록 등):</span>{" "}
                앱 삭제 시 자동 파기
              </li>
              <li>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-neutral-400">
                  <tr className="border-b border-neutral-800">
                    ...
                    <td className="py-2">Firebase Analytics (서비스 이용 분석), Google AdMob (광고 게재), Firebase Cloud Messaging (푸시 알림)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <Section title="6. 개인정보의 파기 절차 및 방법">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li>
                ...
                본 앱은 이용자의 개인정보를 별도 서버에 저장하지 않습니다.
              </li>
            </ul>
          </Section>
          ...
          <Section title="8. 개인정보의 안전성 확보 조치">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li>이용자 개인정보의 별도 서버 미저장 (최소 수집 원칙)</li>
            </ul>
          </Section>
